...
$(document).ready(function() {
    let table = $('#employeeTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route("employees.data")); ?>',
        columns: [
            { data: 'name' },
            { data: 'email' },
            { data: 'position' },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Shibin\Desktop\new\default\resources\views/employees/index.blade.php ENDPATH**/ ?>